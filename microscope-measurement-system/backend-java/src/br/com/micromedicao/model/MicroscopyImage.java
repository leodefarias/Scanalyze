...
public class MicroscopyImage {
     ...
     *
     * @return byte[] com os dados da imagem ou null se não houver
     */
     ...
     *
     * @param imagemBlob Array de bytes com os dados da imagem
     */
    ...
    /**
     * Verifica se a imagem possui dados binários armazenados.
     *
     * @return boolean true se há dados binários, false caso contrário
     */
    public boolean hasImagemBlob() {
        return imagemBlob != null && imagemBlob.length > 0;
    }

    /**
     * Obtém o tamanho dos dados binários da imagem em bytes.
     *
     * @return int tamanho em bytes ou 0 se não houver dados
     */
    public int getImagemBlobSize() {
        return imagemBlob != null ? imagemBlob.length : 0;
    }
