...
public class Measurement {
    ...
    /**
     * Área calculada da medição em unidades quadradas (μm²)
     */
    private double area;

    /**
     * Área calculada da medição em pixels
     */
    private double areaPixels;

    /**
     * Escala de conversão utilizada (pixels por micrômetro)
     */
    private double scalePixelsPerUm;
    ...
    /**
     * Construtor completo com informações de área em pixels e escala.
     *
     * @param id Identificador da medição
     * @param sample Amostra associada
     * @param area Área em μm²
     * @param areaPixels Área em pixels
     * @param scalePixelsPerUm Escala de conversão
     * @param dataHora Data e hora da medição
     * @param imagem Imagem associada
     */
    public Measurement(String id, Sample sample, double area, double areaPixels,
                       double scalePixelsPerUm, LocalDateTime dataHora, MicroscopyImage imagem) {
        this(id, sample, area, dataHora, imagem);
        this.areaPixels = areaPixels;
        this.scalePixelsPerUm = scalePixelsPerUm;
    }
    ...
    /**
     * Obtém a área em pixels.
     *
     * @return double valor da área em pixels
     */
    ...
    /**
     * Define a área em pixels.
     *
     * @param areaPixels Novo valor da área em pixels
     */
    ...
    /**
     * Obtém a escala de conversão utilizada.
     *
     * @return double escala em pixels por micrômetro
     */
    public double getScalePixelsPerUm() {
        return scalePixelsPerUm;
    }

    /**
     * Define a escala de conversão utilizada.
     *
     * @param scalePixelsPerUm Escala em pixels por micrômetro
     */
    public void setScalePixelsPerUm(double scalePixelsPerUm) {
        this.scalePixelsPerUm = scalePixelsPerUm;
    }
    ...
    public boolean validarMedicao() {
        ...
        boolean pixelsValidos = this.areaPixels >= 0;
        ...
        if (!pixelsValidos) {
            System.out.println("Erro: Área em pixels não pode ser negativa");
        }
        if (!sampleValida) {
        ...
        return areaValida && pixelsValidos && sampleValida;
    }
    ...
    public String toString() {
        return String.format("Measurement{id='%s', area=%.2f μm², areaPixels=%.2f, dataHora=%s, sample='%s'}",
                id,
                area,
                areaPixels,
